...
// ('next' is just a placeholder, but when referenced at the time fetchAll is called it will be a 'view' function)
...
// Now instead of calling articleView.initIndexPage(), we can call whatever we pass in!
